...
from cqindustry.barrier import (
    jersey_shape,
    barrier_straight,
    barrier_cross,
    barrier_curved,
...
barrier_c = barrier_cross(j_shape,extrude=22).translate((0,0,barrier_height/2))
...
cq.exporters.export(barrier, 'stl/barrier_alt.stl')
cq.exporters.export(barrier_taper, 'stl/barrier_alt_taper.stl')
cq.exporters.export(barrier_c, 'stl/barrier_alt_c.stl')
...
cq.exporters.export(barrier_curve_60, 'stl/barrier_alt_curve_60.stl')
...
cq.exporters.export(barrier_diag_right, 'stl/barrier_alt_diag_right.stl')
cq.exporters.export(barrier_diag_left, 'stl/barrier_alt_diag_left.stl')
